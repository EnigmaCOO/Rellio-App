        ...
        <section aria-label="Rellio hero" className="relative isolate h-screen overflow-hidden pt-20">
          ...
          <div className="absolute inset-0">
            ...
            <button
              ...
              className="absolute top-[32%] left-[14%] w-[64px] h-[92px] md:top-[34%] md:left-[20%] md:w-[72px] md:h-[104px] transition-all duration-300 hover:scale-105 hover:brightness-110 hover:drop-shadow-[0_0_30px_rgba(255,215,0,0.8)] z-10"
              title="Explore Torah"
