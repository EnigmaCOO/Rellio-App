      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-4 sm:px-6 py-12 md:py-0">
          <div className="max-w-4xl w-full">
            ...
            <div className="hidden md:block absolute inset-x-0 top-16 bg-transparent backdrop-blur-sm border border-gold/60 rounded-2xl mx-4 lg:mx-auto lg:max-w-4xl">
