        ...
        <div className="mb-6">
          ...
          <div className="flex items-center justify-center space-x-4 p-3 bg-gray-50 rounded-lg border border-scripture-200">
            ...
            <div
              ...
              title="Holy Bible"
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="text-blue-600 hover:text-blue-500">
            ...
            <div
              ...
              title="Quran"
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="text-green-600 hover:text-green-500">
            ...
            <div
              ...
              title="Torah"
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="text-blue-700 hover:text-blue-600">
            ...
            <div
              ...
              title="Tripitaka"
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="text-orange-600 hover:text-orange-500">
            ...
            <div
              ...
              title="Bhagavad Gita"
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="text-orange-700 hover:text-orange-600">
