...
- **July 11, 2025 11:03 PM**: Header cleanup - removed "Rellio Scripture Library" text and search bar from header, keeping only logo and settings button for minimal design. Also removed Recent Readings section entirely from navigation panel.
